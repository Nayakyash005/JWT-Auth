...
const router = Router();
router.get("/profile", authenticationJWT, Profile); // so the first the authentication will accur and the it will check wheather the user has correct token or not
